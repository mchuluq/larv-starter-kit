...
@section('content')
<div class="container" id="app-reset-password-page">
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-4 col-sm-8">
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-3">
                    <h5 class="d-block mb-0">Reset password</h5>
                    <small class="d-block">enter new username and password</small>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <div class="form-floating">
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $name ?? old('name') }}" required autofocus placeholder="username">
                ...
                <div class="mb-3">
                    <div class="input-group" id="input-password-group">
                        <div class="form-floating mb-3">
                            <input id="password" type="password" class="form-control rounded @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="new password">
